           ...
           @if(count(Cart::content())>0)
            <div class="table-responsive">
                <table class="timetable_sub ">
                    ...
                    <tbody>
                    @foreach(Cart::content() as $urunler)
                    <tr class="rem1">
                        <td class="invert">{{$urunler->qty}}</td>
                        <td class="invert-image">
                            <a href="single.html">
                                <img src="/upload/urunler/{{$urunler->options->resim}}" alt=" " class="img-responsive">
                            </a>
                        </td>

                        <td class="invert">{{$urunler->name}}</td>
                        <td class="invert">{{$urunler->price}} TL</td>
                        <td class="invert">{{$urunler->subtotal}} TL</td>

                        <td class="invert">
                            <form action="{{route('sepet.kaldir',$urunler->rowId)}}" method="POST">
                                {{csrf_field()}}
                                {{method_field('DELETE')}}
                                <input type="submit" class="btn btn-danger tour" value="Kaldır">
                ...
                <br>
                <a style="float: right;" href="#" class="btn btn-primary tour">Ödeme Yap</a>
                <a style="float: left;" href="#" class="btn btn-primary tour">Sepeti Boşalt</a>
