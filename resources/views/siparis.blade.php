                                            ...
                                            <div class="credit-card-wrapper">
                                                <div class="first-row form-group">
                                                    <div class="controls">
                                                        ...
                                                        <input class="billing-address-name form-control" type="text" name="adsoyad" placeholder="Ad Soyad">
                                                    </div>
                                                    <div class="paymntf_card_number_grids my-2">
                                                        <div class="fpay_card_number_grid_left">
                                                            <div class="controls">
                                                                <label class="control-label">Telefon</label>
                                                                <input class="form-control" type="text" name="telefon" inputmode="numeric" autocomplete="cc-number"
                                                                       autocompletetype="cc-number" x-autocompletetype="cc-number" placeholder="Telefon">
                                                            </div>
                                                        </div>
                                                        <div class="fpay_card_number_grid_right ">
                                                            <div class="controls">
                                                                ...
                                                                <textarea placeholder="Adres" class="form-control" id="exampleFormControlTextarea1" rows="3"></textarea>
                                    ...
                                    <form action="#" method="post" class="creditly-card-form-2 shopf-sear-headinfo_form">
                                        <section class="creditly-wrapper payf_wrapper">
                                            <div class="credit-card-wrapper">
                                                ...
                                                <h3 style="color:black;">Ödenecek Tutar = {{Cart::total()}}</h3>
