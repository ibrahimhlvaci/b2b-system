    ...
    <div class="container py-xl-4 py-lg-2">
        ...
        <div class="row">
            <div class="col-lg-5 col-md-8 single-right-left ">
                <div class="grid images_3_of_2">
                    <div class="flexslider">
                        <ul class="slides">
                            <li data-thumb="/upload/urunler/{{$urunler->resim}}">
                                <div class="thumb-image">
                                    <img src="/upload/urunler/{{$urunler->resim}}" data-imagezoom="true" class="img-fluid" alt=""> </div>
                            </li>
            ...
            <div class="col-lg-7 single-right-left simpleCart_shelfItem">
                <h3 class="mb-3">{{$urunler->urun_adi}}</h3>
                <p class="mb-3">
                    <span class="item_price">{{$urunler->fiyati}}</span>
