                    ...
                    <div class="mt-2 mt-md-0">
                        <div class="dropdown">
                            ...
                            <div class="dropdown-menu dropdown-menu-right">
                                <a class="dropdown-item" href="{{route('yonetim.marka.ekle')}}">Marka Ekle</a>
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-right">
                                                    <div class="dropdown">
                                                        ...
                                                        <div class="dropdown-menu dropdown-menu-right">
                                                            <a href="{{route('yonetim.marka.duzenle',$marka->id)}}" class="dropdown-item">Düzenle</a>
                                                            <a href="{{route('yonetim.marka.sil',$marka->id)}}" class="dropdown-item">Sil</a>
